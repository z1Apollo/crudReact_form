            ...
            <Form onSubmit={handleSubmit}>
                ...
                <DivForm>
                    ...
                    <div>
                        ...
                        <input name="telefone" value={formulario.telefone} onChange={handleChange} />
                    </div>
                    <div>
                        <label>CPF:</label> <br />
                        <input name="cpf" value={formulario.cpf} onChange={handleChange} />
                    </div>
                    <div>
                        <label>Nascimento:</label> <br />
                        <input name="nascimento" value={formulario.nascimento} onChange={handleChange} />
                    </div>
                </DivForm>
